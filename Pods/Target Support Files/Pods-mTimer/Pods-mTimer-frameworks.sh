...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/CDYFoundation/CDYFoundation.framework"
  install_framework "$BUILT_PRODUCTS_DIR/CDYObjectModel/CDYObjectModel.framework"
